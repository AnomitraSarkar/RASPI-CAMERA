...
original_output = cv2.VideoWriter('original_output.mp4', fourcc, 20.0, (640, 480))  # 640x480 resolution
stabilized_output = cv2.VideoWriter('stabilized_output.mp4', fourcc, 20.0, (640, 480))  # 640x480 resolution
...
while True:
    ...
    if len(matches) > 4:  # Ensure enough matches
